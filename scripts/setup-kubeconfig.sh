...
# this script is honestly pretty sloppy and not that important its just here to help accelerate a piece of
# the setup process as setting up a kubectl config can be otherwise slightly bothersome
